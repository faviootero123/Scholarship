...
namespace WCS
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMvc().AddNewtonsoftJson(options => options.SerializerSettings.ReferenceLoopHandling = Newtonsoft.Json.ReferenceLoopHandling.Serialize);
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IServiceProvider serviceProvider, WcsContext context)
        {
            ...
            EnsureSettingsExist(serviceProvider);
        }

        private void EnsureSettingsExist(IServiceProvider serviceProvider)
        {
            var db = serviceProvider.GetRequiredService<WcsContext>();
            db.Database.EnsureCreated();
            Assistant.GetSettings(SettingName.HelpPageMessage, db);
            Assistant.GetSettings(SettingName.FrontPageMessage, db);
        }
