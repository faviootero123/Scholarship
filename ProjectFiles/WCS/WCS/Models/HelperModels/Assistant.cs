...
namespace WCS.Models
{
    public static class Assistant
    {
        ...
        public static AwardCycle GetCurrentAwardCycle(WcsContext context)
        {
            ...
            var awardCycle = context.AwardCycles.OrderBy(c => c.StartDate).FirstOrDefault(c => c.Status == CycleStatus.Open || c.Status == CycleStatus.Judging);
            if (awardCycle is not null)
            {
                return awardCycle;
            }
