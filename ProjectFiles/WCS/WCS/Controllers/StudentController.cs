    ...
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (user != null)
            {
                ...
                List<StudentForm> studentForms = await _context.StudentForms
        ...
        public async Task<IActionResult> CreateStudentProfile([Bind("Prefix,BirthDate,Address,Address2,City,State,ZipCode,Gender," +
            ...
            "CsInterest,ScholarshipAidHistory,StemActivities,AchievementsHistory,StudentCourses,WNumber")] StudentProfile profile)
        {
